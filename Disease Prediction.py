...
def about():
    ...
    st.sidebar.info(
        "This is a demo app built with Streamlit. For more information, see [GitHub repository](https://github.com/your-username/your-repo-name)."
    )
    ...
    st.write("- It gives more accuracy than any of prediction application")
    st.write("- Whenever, WhereEver Check Your Disease")
    st.header("Usage")
    st.write("To run this app, run the following command:")
    st.code("streamlit run app.py")
    st.header("Contact")
    st.write("If you have any questions or feedback, please reach out to me at your-email@example.com.")
